...
describe('Service Tests', () => {
  describe('Societe Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Societe(0, 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Societe', async () => {
      ...
      it('should update a Societe', async () => {
        const returnedFromService = Object.assign(
          {
            idsociete: 1,
            libelle: 'BBBBBB',
      ...
      it('should return a list of Societe', async () => {
        const returnedFromService = Object.assign(
          {
            idsociete: 1,
            libelle: 'BBBBBB',
      ...
      it('should delete a Societe', async () => {
